...
@Autonomous(name="autoRight", group="Test")
...
//        BRwheel.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        ...
        if (opModeIsActive()) {
            ...
            lift.setPower(  -10   );
            claw.setPosition(claw.getPosition() - 0.05F);

            runMotors((float)-0.176667,(float)-0.176667,(float)-0.18,(float)-0.18,(int)(1225 * CtT));
            ...
            runMotors((float)0.18,(float)-0.18,-(float)0.2,(float)0.2,(int)(100 * CtT));

            rTime = 0;

            while (rTime < 200){

                claw.setPosition(claw.getPosition() - 0.005F);

            }

            runMotors((float)-0.18,(float) 0.18, (float) 0.2, (float)-0.2, (int)(100 * CtT));
            runMotors((float) 0.18,(float) 0.18, (float) 0.18,(float) 0.18,(int)(425 * CtT));
            runMotors((float) 0.18,(float) 0.18, (float)-0.2, (float)-0.2, (int)(90  * DtT));
