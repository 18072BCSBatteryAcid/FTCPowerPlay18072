    ...
    */
    ...
    public void runOpMode(){
        ...
        if(opModeIsActive()){
            ...
            //use 95 for left and 100 for right
            /*
            ...
            */
            ...
            /*
            moveTiles(Direction.LEFT, 2.5);
            sleep(100);
            scorePole(LiftLevel.HIGH_J);
            moveTiles(Direction.RIGHT, 0.5);
            rotate(180, Direction.C_WISE);
            sleep(100);
            moveTiles(Direction.FRONT, 1);
            moveLift(LiftLevel.FIVE);
            claw.setPosition(0);
            slightMove(Direction.FRONT);
            sleep(100);
            claw.setPosition(1);
            sleep(100);
            moveLift(LiftLevel.CLEAR);
            sleep(100);
            slightMove(Direction.BACK);
            sleep(100);
            ...
            rotate(180, Direction.C_WISE);
            sleep(100);
            moveTiles(Direction.LEFT, 0.5);
            moveLift(LiftLevel.GROUND);
            sleep(100);
            scorePole(LiftLevel.HIGH_J);
            sleep(100);
            moveTiles(Direction.RIGHT, 3.5);
            */
